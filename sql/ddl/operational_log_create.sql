...
CREATE OR REPLACE PROCEDURE operational_log.bronze_ingest_log_table_create()
LANGUAGE plpgsql

as $$
BEGIN
drop table if exists operational_log.bronze_ingest_log;
create table operational_log.bronze_ingest_log(
    ingestion_id serial,
...
call operational_log.bronze_ingest_log_table_create();
...
create table operational_log.bronze_ingest_safetynet(
        ...
        silver_main_upsert_row_count int,
        ...
        silver_main_upsert_executing_time INTERVAL,
